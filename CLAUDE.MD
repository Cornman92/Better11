...
- **BetterExplorer**: A Windows Explorer-like application that combines the best features from other file explorer applications into one performance-focused application
